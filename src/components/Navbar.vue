<template>
      ...
      <header class="text-slate-700 relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
        <a href="/" class="flex cursor-pointer items-center whitespace-nowrap text-2xl font-black transition-colors hover:text-cyan-500">
          <span class="mr-2 text-4xl text-cyan-500 transition-transform transform hover:scale-110">
            <!-- Tambahkan efek transform scale pada ikon -->
        ...
        <label class="absolute top-5 right-7 cursor-pointer md:hidden transition-transform transform hover:rotate-90" for="navbar-open">
          <!-- Tambahkan efek transform rotate pada ikon -->
        ...
        <nav aria-label="Header Navigation" class="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
          <ul class="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
            <li class="font-bold md:mr-12"><a href="blog" class="transition-colors hover:text-cyan-500">Blog</a></li>
            <li class="md:mr-12"><a href="kontak" class="transition-colors hover:text-cyan-500">Kontak</a></li>
            <li class="md:mr-12"><a href="event" class="transition-colors hover:text-cyan-500">Event</a></li>
            <li class="md:mr-12"><a href="tentangkami" class="transition-colors hover:text-cyan-500">Tentang Kami</a></li>
            <li class="md:mr-12">
  ...
  <script>
  export default {
    // Logika terkait navbar (jika ada) di sini
  }
  </script>
  
  <style scoped>
  /* Gaya terkait navbar di sini */
  /* Gaya terkait navbar di sini */
nav {
  background-color: #4a5568; /* Warna latar belakang */
}
